...
- **GitHub:** https://github.com/IRISX-AI/IRIS-AI
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/IRISX-AI/IRIS-AI/discussions) or open an Issue first. Please don't spend 20 hours building a massive feature without checking if it aligns with the project roadmap.
