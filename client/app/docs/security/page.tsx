...
export default function DocsSecurityPage() {
  ...
  return (
    ...
    >
        ...
        {[
          ...
          return (
            ...
            >
              ...
              <h3 className="text-white font-bold text-base font-mono">{item.title}</h3>
              <p className="text-zinc-500 text-xs font-mono leading-relaxed">{item.desc}</p>
            </div>
          );
        })}
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="bg-[#050505] border border-white/10 rounded-2xl p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 font-mono text-xs text-zinc-300">
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="p-2.5 rounded-lg bg-white/5 border border-white/10 text-white shrink-0 h-fit">01</div>
              <div className="space-y-1">
                <span className="text-white font-bold block text-sm">V8 Bytecode Compilation</span>
                <p className="text-zinc-500 leading-relaxed">
                  All TypeScript files inside the Main Process (including <code className="text-[#39FF14]">iris-ai.ts</code> and <code className="text-[#39FF14]">tools.ts</code>) are compiled directly into raw machine binary V8 bytecode (.jsc files). This prevents standard reverse engineering and source viewing.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="p-2.5 rounded-lg bg-white/5 border border-white/10 text-white shrink-0 h-fit">02</div>
              <div className="space-y-1">
                <span className="text-white font-bold block text-sm">String Obfuscation</span>
                <p className="text-zinc-500 leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="p-2.5 rounded-lg bg-white/5 border border-white/10 text-white shrink-0 h-fit">03</div>
              <div className="space-y-1">
                <span className="text-white font-bold block text-sm">ASAR Hash Integrity Checks</span>
                <p className="text-zinc-500 leading-relaxed">
            ...
            <div className="flex gap-4">
              <div className="p-2.5 rounded-lg bg-white/5 border border-white/10 text-white shrink-0 h-fit">04</div>
              <div className="space-y-1">
                <span className="text-white font-bold block text-sm">Window & Context Isolation</span>
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Vault Configuration */}
        <div className="bg-[#050505] border border-white/10 rounded-2xl p-6 space-y-4 hover:border-white/20 transition-all font-mono">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between p-3 rounded-xl bg-black/50 border border-white/5">
              ...
              <code className="text-[#39FF14] text-[10px]">"Lock the system vault"</code>
            </div>
            <div className="flex items-center justify-between p-3 rounded-xl bg-black/50 border border-white/5">
              <span className="text-zinc-400">Biometric Face Check</span>
              <code className="text-[#39FF14] text-[10px]">Multi-Face Validation</code>
            </div>
          </div>
        </div>

        {/* System Warnings */}
        <div className="bg-[#050505] border border-orange-500/20 rounded-2xl p-6 space-y-4 hover:border-orange-500/30 transition-all font-mono">
          <h4 className="text-lg font-bold text-white flex items-center gap-2">
