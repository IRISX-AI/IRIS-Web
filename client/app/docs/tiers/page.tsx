    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-4">
        ...
        <p className="text-zinc-400 text-lg leading-relaxed max-w-3xl ">
          ...
          host the frontend layers, while sponsors fund core engine modules.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-zinc-400 text-xs  leading-relaxed">
          Open Core allows IRIS to distribute high-fidelity user interface
          configurations, layouts, and tools under a standard MIT license, while
          safeguarding proprietary agent orchestration techniques and live voice
          routing protocols under private code structures.
        </p>
      </motion.div>
