  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [
          '"Create a folder named assets in my current directory"',
          '"Make folder UI under components"',
        ],
      },
      {
        ...
        commands: [
          '"Read the index.js file inside the root"',
          '"Write a server.js file with simple express setup"',
        ],
      },
      {
        ...
        commands: [
          ...
          '"Organize my chaotic project directories"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Index my src folder"',
          '"Embed my docs folder for search"',
        ],
      },
      {
        ...
        commands: [
          ...
          '"Search for codebase configuration hooks"',
        ],
      },
      {
        ...
        commands: [
          '"Scan my screenshot folder"',
          '"Analyze this error screenshot and find a solution"',
        ],
      },
    ],
  },
    ...
    tools: [
      ...
      },
      {
        ...
        commands: [
          ...
          '"Open local server to external connection"',
        ],
      },
      {
        ...
        commands: [
          '"Run the development startup sequence"',
          '"Execute my custom deploy macro"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Move this active window to the left side"',
      ...
      },
      {
        ...
        commands: [
          ...
          '"Scroll down fifty percent"',
          '"Click at coordinates 800 by 600"',
        ],
      },
      {
        ...
        commands: [
          '"Extract code from active window"',
          '"Type my secure email address in the active input box"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Remember that my API host is port 5000"',
          '"Forget my old server address"',
        ],
      },
      {
        ...
        commands: [
          '"What is my current project setup?"',
          '"What wake word configs did I set earlier?"',
        ],
      },
      {
        name: "Read Emails",
        ...
        commands: [
          ...
          '"Summarize my last developer newsletters"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Search for the latest NextJS 16 stable features"',
          '"Get today\'s weather in San Francisco"',
        ],
      },
      {
        ...
        commands: [
          '"Play synthwave music on Spotify"',
          '"Pause playback"',
          '"Skip to next track"',
        ],
      },
      {
        ...
        commands: [
          '"Get current stock price of Apple"',
          '"Compare NVIDIA and AMD performance charts"',
        ],
      },
      {
        ...
        commands: [
          '"Generate an image of a neon forest"',
          '"Inject a cyber-green background to the current site"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Send WhatsApp message to Harsh saying: Build is online!"',
          '"Schedule a WhatsApp message for tomorrow morning"',
        ],
      },
      {
        ...
        commands: [
          '"Draft an email to client about project submission"',
          '"Send email containing build report"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Open Slack on my Android device"',
          '"Get my phone\'s battery level"',
      ...
      },
      {
        ...
        commands: [
          '"Swipe down on my phone screen"',
          '"Remote click coordinate 400 and 800"',
        ],
      },
      {
        ...
        commands: [
          '"Push my screenshot to my Android phone"',
          '"Pull documents from mobile directory"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          '"Research current breakthroughs in quantum computing and sync it to Notion"',
        ],
      },
      {
        ...
        commands: [
          '"Ingest my codebase into database"',
          '"Ask Oracle: how does the routing layout hook together?"',
        ],
      },
    ],
  },
    ...
    tools: [
      {
        ...
        commands: [
          ...
          '"Activate biometric lockdown mode"',
        ],
      },
    ],
  },
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3
                      className={`text-lg font-bold transition-all ${isExpanded ? "text-[#39FF14]" : "text-white"}`}
                    >
                      {category.title}
                    </h3>
              ...
              {isExpanded && (
                <div className="px-6 pb-6 pt-2 border-t border-white/5 space-y-6">
                  {category.tools.map((tool, tIdx) => (
                    <div
                      key={tIdx}
                      className="space-y-3 pl-2 border-l border-[#39FF14]/30"
                    >
                      <h4 className="text-white font-bold tracking-tight text-sm  flex items-center gap-2">
                      ...
                      <div className="space-y-1.5 bg-black/60 p-3 rounded-xl border border-white/5">
                        ...
                        <div className="space-y-1 pl-1">
                          {tool.commands.map((cmd, cIdx) => (
                            <code
                              key={cIdx}
                              className="block text-xs  text-[#39FF14]/80 hover:text-[#39FF14] transition-colors leading-relaxed"
                            >
                              {cmd}
                            </code>
                          ))}
