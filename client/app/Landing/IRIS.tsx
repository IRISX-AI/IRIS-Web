...
export default function DeprecatedSite() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-zinc-100 flex flex-col items-center justify-center relative overflow-hidden font-sans px-6 selection:bg-[#39FF14] selection:text-black font-manrope">
